function skinChanger() {
    $(".right-sidebar .demo-choose-skin li").on("click", function () {
        var a = $("body"), b = $(this), c = $(".right-sidebar .demo-choose-skin li.active").data("theme");
...
function setSkinListHeightAndScroll() {
    var a = $(window).height() - ($(".navbar").innerHeight() + $(".right-sidebar .nav-tabs").outerHeight()),
        b = $(".demo-choose-skin");
    b.slimScroll({destroy: !0}).height("auto"), b.parent().find(".slimScrollBar, .slimScrollRail").remove(), b.slimscroll({
        height: a + "px",
...
function loadTracking() {
    ...
    }(window, document, "script", "https://www.google-analytics.com/analytics.js", "ga"), ga("create", trackingId, "auto"), ga("send", "pageview")
}
    ...
    activate: function () {
        ...
        if ("undefined" != typeof $.fn.slimScroll) {
            var a = $.AdminBSB.options.leftSideBar,
                ...
                c = $(".list");
            c.slimScroll({destroy: !0}).height("auto"), c.parent().find(".slimScrollBar, .slimScrollRail").remove(), c.slimscroll({
                height: b + "px",
                color: a.scrollColor,
                size: a.scrollWidth,
...
$.AdminBSB.search = {
    ...
    activate: function () {
        ...
        var b = $.AdminBSB.options.dropdownMenu.effectIn, c = $.AdminBSB.options.dropdownMenu.effectOut, d = $(a),
            e = $(".dropdown-menu", a);
        if (d.size() > 0) {
            var f = d.data("effect-in"), g = d.data("effect-out");
            void 0 !== f && (b = f), void 0 !== g && (c = g)
        }
        return {target: a, dropdown: d, dropdownMenu: e, effectIn: b, effectOut: c}
...
$.AdminBSB.browser = {
    ...
    $.AdminBSB.browser.activate(), $.AdminBSB.leftSideBar.activate(), $.AdminBSB.rightSideBar.activate(), $.AdminBSB.navbar.activate(), $.AdminBSB.dropdownMenu.activate(), $.AdminBSB.input.activate(), $.AdminBSB.select.activate(), $.AdminBSB.search.activate(), setTimeout(function () {
    ...
    var a = document.getElementById("morphsearch"), b = a.querySelector("input.morphsearch-input"),
        c = a.querySelector("span.morphsearch-close"), d = isAnimating = !1, e = function (c) {
