...
switch ($acao){
    ...
    case 'validar':
        ...
        {
            $rsLogin->setEmail($_POST['username']);
            $rsLogin->setPassword($_POST['password']);
            echo $rsLogin->userLogin($rsLogin->getEmail(), $rsLogin->getPassword());
        }
